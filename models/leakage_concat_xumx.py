...
class Leakage_Concat_XUMX(BaseModel):
    ...
    def forward(self, wav):
        ...
        split_mix = torch.split(mixture, 2, dim=2) #since the first 2 channels should correspond to the wav of the mix.

        masked_mixture = self.apply_masks(split_mix[0], est_masks)
